package cn.jt.bds.framework.processor.datasource.factory;
...
import cn.jt.bds.framework.processor.datasource.jdbc.adapter.*;
import cn.jt.bds.framework.processor.datasource.JDBCAdapter;
import cn.jt.bds.framework.processor.datasource.nosql.adapter.HiveJDBCAdapter;
import cn.jt.bds.framework.processor.datasource.nosql.adapter.MongoDBJDBCAdapter;
...
import static cn.jt.bds.framework.common.exception.enums.StructuredErrorCodeConstants.DATABASE_INPUT_TYPE_ERROR;
import static cn.jt.bds.framework.common.exception.enums.StructuredErrorCodeConstants.UNSUPPORTED_DATABASE_TYPE;
import static cn.jt.bds.framework.common.exception.util.ServiceExceptionUtil.exception;
