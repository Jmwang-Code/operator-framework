...
public enum SQLFunctionEnum implements SQLDQL{
    ...
    MAX_BY("MAX_BY","返回与 expr2 的最大值关联的 expr1 的值","返回与 expr2 的最大值关联的 expr1 的值。",2),

    COLLECT_SET("COLLECT_SET","返回一个对expr去重后的数组","可选参数max_size，通过设置该参数能够将结果数组的大小限制为 max_size 个元素。 得到的结果数组中不包含NULL元素，数组中的元素顺序不固定。该函数具有别名group_uniq_array。",2);
