...
public class QueryJoin {
     ...
     */
    public QueryJoin(SQLJoinEnum type, String table, String alias, String onCondition) {
        this.type = type;
        this.table = table;
        this.alias = alias;
     ...
     * @param onCondition 连接条件
     */
    public QueryJoin(SQLJoinEnum type, SQLQueryBuilder subQuery, String alias, String onCondition) {
        this.type = type;
