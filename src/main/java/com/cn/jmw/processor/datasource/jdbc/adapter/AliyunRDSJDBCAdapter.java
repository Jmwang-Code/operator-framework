 ...
 */
@Slf4j
public class AliyunRdsJdbcAdapter extends AbstractJdbcAdapter {
     ...
     */
    public AliyunRdsJdbcAdapter(String hostname, Integer port, String databaseName, String username, String password, JdbcAdapterDataSourceConfig config, String connectionUser, Boolean test, ConnectionStringStrategy strategy) {
        super(hostname, port, databaseName, username, password,config,connectionUser,test,strategy);
    }

    public AliyunRdsJdbcAdapter(String hostname, Integer port, String databaseName, String username, String password, JdbcAdapterDataSourceConfig config, Boolean test, ConnectionStringStrategy strategy) {
...
//     */
//    public AliyunRdsJdbcAdapter(String hostname, Integer port, String databaseName, String username, String password, JdbcAdapterDataSourceConfig config, Boolean test) {
...
//     * 构造函数，使用默认配置。
//     */
//    public AliyunRdsJdbcAdapter(String hostname, Integer port, String databaseName, String username, String password, Boolean test)  {
...
//    }
     ...
     * 添加随机抽样逻辑。
     * <p>
     * 该方法通过 LIMIT 实现抽样，不允许使用 ORDER BY 或其他限制性语句。
     * </p>
     *
     * @param sqlQueryMontage SQL 查询组合对象
     * @param n               抽样点（未使用）
     * @param m               抽样数量
     * @return 包含抽样逻辑的 SQL 列表
     */
    @Override
